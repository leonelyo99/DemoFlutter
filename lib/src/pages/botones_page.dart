...
class BotonesPage extends StatelessWidget {
  ...
  Widget _fondoApp() {
    final gradiente = Container(
      ...
      decoration: BoxDecoration(
          gradient: LinearGradient(
              //un degrades
              begin: FractionalOffset(0.0, 0.6), //de arriba
              end: FractionalOffset(0.0, 1.0), //a abajo
              colors: [
    ...
    final cajaRosa = Transform.rotate(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            gradient: LinearGradient(//un degrades de izquierda a derecha
                colors: [
    ...
    return Stack(
      children: <Widget>[
        gradiente,
        Positioned(
            //ubicar un elemento con cordenadas especificas
            top: -100.0,
            child: cajaRosa)
      ],
    );
  ...
  Widget _titulos() {
    return SafeArea(
      child: Container(
        padding: EdgeInsets.all(20.0), //en todos lados un padding de 20
        child: Column(
          crossAxisAlignment:
  ...
  Widget _bottomNavigationBar(context) {
    //para poder modificar el color de los tabs
    return Theme(
